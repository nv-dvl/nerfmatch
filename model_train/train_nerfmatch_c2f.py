...
from nerfmatch.nerfmatch_c2f_trainer import train
...
def main():
    ...
    parser.add_argument("--c2f_ckpt", type=str, default=None)
    ...
    parser.add_argument("--fine_sa", type=int, default=1)
    parser.add_argument("--fsa_type", type=str, default="full")

    # Optim
    parser.add_argument("--update_conf", action="store_true")
    parser.add_argument("--batch_size", type=int, default=2)
    parser.add_argument("--clr", type=float, default=0.0048)
    parser.add_argument("--cbs", type=int, default=16)
    parser.add_argument("--adapt_lr", action="store_true")
    parser.add_argument("--max_epochs", type=int, default=50)
    parser.add_argument("--coarse_only_epochs", type=int, default=0)
    ...
    if args.update_conf:
        config.model.coarse_ckpt = args.coarse_ckpt
        config.model.c2f_ckpt = args.c2f_ckpt
        ...
        config.model.fsa_type = args.fsa_type
        config.model.fine_sa = args.fine_sa

        config.exp.batch_size = args.batch_size
        config.exp.max_epochs = args.max_epochs
        config.optim.coarse_only_epochs = args.coarse_only_epochs
